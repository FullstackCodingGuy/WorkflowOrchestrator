...
export function MegaFileMenu({
  ...
  const handleTemplateSelect = (templateId: string) => {
    if (templateId === 'blank') {
      onNew();
    } else if (templateId === 'browse-templates') {
      // Future implementation for template browser
      console.log('Browse templates feature coming soon...');
      // Could open a modal or navigate to template gallery
      ...
      {isOpen && (
        <div className="absolute top-full left-0 z-50 mt-1 overflow-hidden shadow-2xl">
          <div className="bg-white border border-gray-200 rounded-sm w-[800px]">
            ...
            <div className="grid grid-cols-2 bg-white min-h-[350px]">
              ...
              <div className="bg-white p-6">
                ...
                {activeSection === 'new' && (
                  <div className="space-y-4">
                    <div>
                      <h3 className="text-lg font-semibold text-gray-800 mb-2">Create New Document</h3>
                      <p className="text-sm text-gray-600 mb-4">Choose how you want to start your workflow design.</p>
                    </div>
                    ...
                    <div className="grid grid-cols-2 gap-3">
                      ...
                      <div
                        ...
                        className="group p-4 rounded-lg border border-gray-200 hover:border-blue-300 
                                  ...
                                  hover:shadow-md bg-white text-center"
                      ...
                      >
                        <div className="w-10 h-10 bg-gradient-to-br from-blue-500 to-blue-600 
                                      ...
                                      group-hover:scale-105 transition-transform duration-200 mx-auto mb-2">
                          <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 4v16m8-8H4" />
                          </svg>
                        </div>
                        <h4 className="font-medium text-gray-800 group-hover:text-blue-700 text-sm mb-1">Blank Canvas</h4>
                      ...
                      <div
                        ...
                        className="group p-4 rounded-lg border border-gray-200 hover:border-green-300 
                      ...
                      >
                        ...
                        <h4 className="font-medium text-gray-800 group-hover:text-green-700 text-sm mb-1">Quick Start</h4>
                        <p className="text-xs text-gray-600">Basic workflow</p>
                      </div>

                      {/* Decision Flow Tile */}
                      <div
                        onClick={() => handleTemplateSelect('conditional-workflow')}
                        className="group p-4 rounded-lg border border-gray-200 hover:border-amber-300 
                      ...
                      >
                        ...
                        <h4 className="font-medium text-gray-800 group-hover:text-amber-700 text-sm mb-1">Decision Flow</h4>
                        <p className="text-xs text-gray-600">With branching</p>
                      </div>

                      {/* Animated Flow Tile */}
                      <div
                        onClick={() => handleTemplateSelect('animated-basic')}
                        className="group p-4 rounded-lg border border-gray-200 hover:border-purple-300 
                                  hover:bg-purple-50 cursor-pointer transition-all duration-200 
                                  hover:shadow-md bg-white text-center"
                      ...
                      >
                        ...
                        <h4 className="font-medium text-gray-800 group-hover:text-purple-700 text-sm mb-1">Animated Flow</h4>
                        <p className="text-xs text-gray-600">With effects</p>
                      </div>
                    </div>
                    ...
                    <div className="pt-3 border-t border-gray-200">
                      <button
                        onClick={() => handleTemplateSelect('browse-templates')}
                      ...
                      >
                        <div className="flex items-center justify-center space-x-2 text-gray-600 group-hover:text-indigo-600">
                          <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} 
                                  d="M19 11H5m14 0a2 2 0 012 2v6a2 2 0 01-2 2H5a2 2 0 01-2-2v-6a2 2 0 012-2m14 0V9a2 2 0 00-2-2M5 11V9a2 2 0 012-2m0 0V5a2 2 0 012-2h6a2 2 0 012 2v2M7 7h10" />
                          </svg>
                          <span className="text-sm font-medium">Browse All Templates</span>
                          <span className="text-xs bg-gray-200 px-2 py-1 rounded-full group-hover:bg-indigo-200">Coming Soon</span>
                        </div>
                      </button>
                    </div>
                  </div>
