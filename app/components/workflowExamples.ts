...
export const workflowExamples: WorkflowExample[] = [
  ...
  },
  {
    ...
    edges: [
      { id: 'itu-e-start-hr', source: 'itu-start', target: 'itu-action-hr', animated: false, data: { animatedColor: '#6c2bd7', completedColor: '#22c55e' } },
      { id: 'itu-e-hr-cond', source: 'itu-action-hr', target: 'itu-cond-hr', animated: false, data: { animatedColor: '#6c2bd7', completedColor: '#22c55e' } },
      { id: 'itu-e-condhr-setup', source: 'itu-cond-hr', sourceHandle: 'itu-cond-hr-source-true', target: 'itu-action-it-setup', label: 'Yes', animated: false, data: { animatedColor: '#6c2bd7', completedColor: '#22c55e' } },
      { id: 'itu-e-condhr-reject', source: 'itu-cond-hr', sourceHandle: 'itu-cond-hr-source-false', target: 'itu-action-reject-hr', label: 'No', animated: false, data: { animatedColor: '#6c2bd7', completedColor: '#22c55e' } },
      { id: 'itu-e-rejecthr-end', source: 'itu-action-reject-hr', target: 'itu-end-rejected-hr', animated: false, data: { animatedColor: '#6c2bd7', completedColor: '#22c55e' } },
      { id: 'itu-e-setup-condit', source: 'itu-action-it-setup', target: 'itu-cond-it-setup-ok', animated: false, data: { animatedColor: '#6c2bd7', completedColor: '#22c55e' } },
      { id: 'itu-e-condit-resource', source: 'itu-cond-it-setup-ok', sourceHandle: 'itu-cond-it-setup-ok-source-true', target: 'itu-action-resource', label: 'Yes', animated: false, data: { animatedColor: '#6c2bd7', completedColor: '#22c55e' } },
      { id: 'itu-e-resource-notify', source: 'itu-action-resource', target: 'itu-action-notify', animated: false, data: { animatedColor: '#6c2bd7', completedColor: '#22c55e' } },
      { id: 'itu-e-notify-complete', source: 'itu-action-notify', target: 'itu-end-complete', animated: false, data: { animatedColor: '#6c2bd7', completedColor: '#22c55e' } },
      { id: 'itu-e-condit-logissue', source: 'itu-cond-it-setup-ok', sourceHandle: 'itu-cond-it-setup-ok-source-false', target: 'itu-action-log-issue', label: 'No', animated: false, data: { animatedColor: '#6c2bd7', completedColor: '#22c55e' } },
      { id: 'itu-e-logissue-delayed', source: 'itu-action-log-issue', target: 'itu-end-delayed', animated: false, data: { animatedColor: '#6c2bd7', completedColor: '#22c55e' } },
    ],
  },
  {
    ...
    edges: [
      { id: 'bla-e-start-docs', source: 'bla-start', target: 'bla-action-docs', animated: false, data: { animatedColor: '#6c2bd7', completedColor: '#22c55e' } },
      { id: 'bla-e-docs-cond', source: 'bla-action-docs', target: 'bla-cond-docs', animated: false, data: { animatedColor: '#6c2bd7', completedColor: '#22c55e' } },
      { id: 'bla-e-conddocs-credit', source: 'bla-cond-docs', sourceHandle: 'bla-cond-docs-source-true', target: 'bla-action-credit', label: 'Yes', animated: false, data: { animatedColor: '#6c2bd7', completedColor: '#22c55e' } },
      { id: 'bla-e-conddocs-reqinfo', source: 'bla-cond-docs', sourceHandle: 'bla-cond-docs-source-false', target: 'bla-action-request-info', label: 'No', animated: false, data: { animatedColor: '#6c2bd7', completedColor: '#22c55e' } },
      { id: 'bla-e-reqinfo-endinc', source: 'bla-action-request-info', target: 'bla-end-incomplete', animated: false, data: { animatedColor: '#6c2bd7', completedColor: '#22c55e' } },
      { id: 'bla-e-credit-cond', source: 'bla-action-credit', target: 'bla-cond-credit', animated: false, data: { animatedColor: '#6c2bd7', completedColor: '#22c55e' } },
      { id: 'bla-e-condcred-risk', source: 'bla-cond-credit', sourceHandle: 'bla-cond-credit-source-true', target: 'bla-action-risk', label: 'Yes', animated: false, data: { animatedColor: '#6c2bd7', completedColor: '#22c55e' } },
      { id: 'bla-e-condcred-reject', source: 'bla-cond-credit', sourceHandle: 'bla-cond-credit-source-false', target: 'bla-action-reject', label: 'No', animated: false, data: { animatedColor: '#6c2bd7', completedColor: '#22c55e' } },
      { id: 'bla-e-risk-cond', source: 'bla-action-risk', target: 'bla-cond-risk', animated: false, data: { animatedColor: '#6c2bd7', completedColor: '#22c55e' } },
      { id: 'bla-e-condrisk-approve', source: 'bla-cond-risk', sourceHandle: 'bla-cond-risk-source-true', target: 'bla-action-approve', label: 'Yes', animated: false, data: { animatedColor: '#6c2bd7', completedColor: '#22c55e' } },
      { id: 'bla-e-condrisk-reject', source: 'bla-cond-risk', sourceHandle: 'bla-cond-risk-source-false', target: 'bla-action-reject', label: 'No', animated: false, data: { animatedColor: '#6c2bd7', completedColor: '#22c55e' } },
      { id: 'bla-e-approve-end', source: 'bla-action-approve', target: 'bla-end-approved', animated: false, data: { animatedColor: '#6c2bd7', completedColor: '#22c55e' } },
      { id: 'bla-e-reject-end', source: 'bla-action-reject', target: 'bla-end-rejected', animated: false, data: { animatedColor: '#6c2bd7', completedColor: '#22c55e' } },
    ],
  },
  {
    ...
    edges: [
      { id: 'smt-e-start-validate', source: 'smt-start', target: 'smt-action-validate', animated: false, data: { animatedColor: '#6c2bd7', completedColor: '#22c55e' } },
      { id: 'smt-e-validate-cond', source: 'smt-action-validate', target: 'smt-cond-valid', animated: false, data: { animatedColor: '#6c2bd7', completedColor: '#22c55e' } },
      { id: 'smt-e-condvalid-exchange', source: 'smt-cond-valid', sourceHandle: 'smt-cond-valid-source-true', target: 'smt-action-exchange', label: 'Yes', animated: false, data: { animatedColor: '#6c2bd7', completedColor: '#22c55e' } },
      { id: 'smt-e-condvalid-failval', source: 'smt-cond-valid', sourceHandle: 'smt-cond-valid-source-false', target: 'smt-action-failed-validation', label: 'No', animated: false, data: { animatedColor: '#6c2bd7', completedColor: '#22c55e' } },
      { id: 'smt-e-failval-end', source: 'smt-action-failed-validation', target: 'smt-end-failed-validation', animated: false, data: { animatedColor: '#6c2bd7', completedColor: '#22c55e' } },
      { id: 'smt-e-exchange-condexe', source: 'smt-action-exchange', target: 'smt-cond-executed', animated: false, data: { animatedColor: '#6c2bd7', completedColor: '#22c55e' } },
      { id: 'smt-e-condexe-confirmfull', source: 'smt-cond-executed', sourceHandle: 'smt-cond-executed-source-true', target: 'smt-action-confirm-full', label: 'Yes (Full)', animated: false, data: { animatedColor: '#6c2bd7', completedColor: '#22c55e' } },
      { id: 'smt-e-confirmfull-endsuccess', source: 'smt-action-confirm-full', target: 'smt-end-success', animated: false, data: { animatedColor: '#6c2bd7', completedColor: '#22c55e' } },
      { id: 'smt-e-condexe-condpartial', source: 'smt-cond-executed', sourceHandle: 'smt-cond-executed-source-false', target: 'smt-cond-partial-fill', label: 'No (Not Full)', animated: false, data: { animatedColor: '#6c2bd7', completedColor: '#22c55e' } },
      { id: 'smt-e-condpartial-notifypartial', source: 'smt-cond-partial-fill', sourceHandle: 'smt-cond-partial-fill-source-true', target: 'smt-action-notify-partial', label: 'Yes (Partial)', animated: false, data: { animatedColor: '#6c2bd7', completedColor: '#22c55e' } },
      { id: 'smt-e-notifypartial-endpartial', source: 'smt-action-notify-partial', target: 'smt-end-partial', animated: false, data: { animatedColor: '#6c2bd7', completedColor: '#22c55e' } },
      { id: 'smt-e-condpartial-failexchange', source: 'smt-cond-partial-fill', sourceHandle: 'smt-cond-partial-fill-source-false', target: 'smt-action-failed-exchange', label: 'No (Complete Fail)', animated: false, data: { animatedColor: '#6c2bd7', completedColor: '#22c55e' } },
      { id: 'smt-e-failexchange-end', source: 'smt-action-failed-exchange', target: 'smt-end-failed-exchange', animated: false, data: { animatedColor: '#6c2bd7', completedColor: '#22c55e' } },
    ],
  },
];
